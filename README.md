...
<head>
    ...
    <meta name="description" content="World's best Social site for helth consultancy">
    <meta name="keywords" content="Stay Happy & Healthy">
    <title>Atharva Sasta</title>
    <link rel="shortcut icon" href="/ved.ico" type="image/x-icon">
...
<body>
    <header>
        <nav>
            ...
            <ul>
                <li><a href="/details/home.html">Home</a></li>
                <li><a href="/details/About.html">About</a></li>
                <li><a href="/details/cotact.html">Contact</a></li>
            </ul>
            <div class="search">
    ...
    <main>
        <div class="container">
            <div class="slider">
                <img src="https://source.unsplash.com/1600x500/?hospital,operation" alt="">
            </div>

            <div class="card">
                <h2 class="my-2">Join the Happy life</h2>
                <div class="cards">
                    <div class="card-item">
                        <img src="https://source.unsplash.com/160x160/?homeopathic,medicine" alt="" width="200px">
                        <div class="lines">
            ...
            <div class="card">
                <h2 class="my-2">Future Healthy life Yoga</h2>
                <div class="cards">
                    <div class="card-item">
            ...
            <div class="card">
                <h2 class="my-2">Best treatment is concentration</h2>
                <div class="cards">
                    <div class="card-item">
    ...
    <footer class="flex-all-center">
        <p>Copyright &copy; atharvasasta.com </p>
    </footer>
</body>
